...
function About() {
  return (
    <div className="mx-12 md:h-[90vh] md:my-20 md:mx-48">
      <div className="hidden w-full md:flex justify-center my-20 text-5xl">
        <span className="text-[#403D3B] mr-2">About </span>
        <span className="text-[#99A19B]"> Studio A</span>
      </div>
      <div className=" flex md:grid xl:grid-cols-2 md:grid-cols-1 justify-center w-full">
        ...
        <div className="md:bg-white">
          <div className="text-center md:text-left lg:my-32 lg:mx-32 md:my-10 md:mx-10">
            <p className="my-5 md:my-6">
              <b>Studio A</b> is a boutique Pilates studio in La Lucia providing
